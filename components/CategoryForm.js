  ...
  const saveCategoryHandler = async (e) => {
    ...
    if (id) {
      ...
      try {
        ...
        let response;
        if (isChangingImage) {
          response = await axios.put("/api/categories2", {
            name,
            description,
      ...
      console.log("❤❤");
      try {
        const response = await axios.post("/api/categories2", {
          name,
          description,
          image: selectedPicture ? selectedPicture.split(",")[1] : null,
        });
                            ...
                            >
                              ...
                              <TableCell sx={{ borderBottom: "none" }}>
                                <div style={{ display: "flex", gap: "8px" }}>
                                  <Link
                                    className="btn-default"
                                    href={`/composition/edit/${composition.id}?categId=${id}`}
                                    style={{
                                      display: "flex",
                                      backgroundColor: "#FFF4E5",
                                      color: "#9C7D51",
                                  ...
                                  <Link
                                    className="btn-red"
                                    href={
                                      "/composition/delete/" + composition.id
                                    }
                                    style={{ display: "flex" }}
                                  >
                                    <svg
